...
short seasons effecting sample sizes of VTR and test fishing encounters resulting uncertainty
...
with a start date of August 1st and end date that was either was observed 
...
yields a date where there would be a reasonable expectation of estimated total encounters
are accumulated at a similar *rate* as the FRAM prediction for the fishery. Given
...
the fishery can be used as a mechanism to decided whether a fishery should be 
